  ...
  <div class="col-md-4">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
          <form id="tab" action="liste.jsp?iddoc=<%=id%>" method="POST">
        <div class="form-group">
        <label>Nom</label>
        <input type="text" class="form-control" name="name" value="<%=nom%>">
        </div>
        <div class="form-group">
        <label>Prenom</label>
        ...
        <div class="form-group">
        <label>Contact</label>
        <input type="text" class="form-control" name="contact" value="<%=cont%>">
        </div>
