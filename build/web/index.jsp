<%-- 
    Document   : index
    Created on : 1 déc. 2016, 08:57:16
    Author     : itu
--%>
...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
    ...
    <ul>
    <li><a href="#" data-target=".dashboard-menu" class="nav-header" data-toggle="collapse"> Accueil<i ></i></a></li>
    ...
    <li data-popover="true" rel="popover" data-placement="right"><a href="insererPat.jsp" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"> Insertion Patient<i ></i></a></li>
        ...
        <li><a href="listeP.jsp" data-target=".legal-menu" class="nav-header collapsed" data-toggle="collapse"> Gestion Medicament<i ></i></a></li>

        <li><a href="choisirPat.jsp" class="nav-header"> Consultation</a></li>
