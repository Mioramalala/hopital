...
<body class=" theme-blue">
    ...
    <jsp:useBean id="obj1" class="pers.Specialisation"/>
        ...
        <%
            String refF = request.getParameter("refFact");
        %>
...
<ul class="nav nav-tabs">
  <li class="active"><a href="#home" data-toggle="tab">Paiement</a></li>
...
<div class="row">
  <div class="col-md-4">
    ...
    <div id="myTabContent" class="tab-content">
      ...
      <button class="btn btn-primary" onclick="consu()"><i class="fa fa-save"></i> Enregistrer</button>
      <button class="btn btn-primary" onclick="ann()"><i class="fa fa-save"></i> Enregistrer</button>
